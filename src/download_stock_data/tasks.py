...
@app.task(bind=True, name='download_stock_data', queue='q_yasmape.download_stock_data')
def download_stock_data(self, **kwargs):
    ...
    try:
        ...
        msg = "When running snakemake workflow: Exception {} - \"{}\" ".format(type(e).__name__, str(e))
        raise TaskFailure(self, e, msg)
